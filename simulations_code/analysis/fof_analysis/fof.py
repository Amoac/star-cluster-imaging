#GRACEFUL EXIT RETURNING -99 FOR VALUES IF NO GROUPS (PRINTING NO GROUPS TO SCREEN)
#RESPACED
...
def find(x,y,z,mass=[-99], b=1, ncut=10):
    ...
    #MAKE A GRACEFUL EXIT HERE IF THERE ARE NO GROUPS ABOVE PARTICLE CUT
    if count == 0:
        print('there are no groups with this linking length')
